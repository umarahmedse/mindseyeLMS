  ...
  return (
    <div className="w-[95%] m-auto flex justify-center items-center h-[70vh] 800px:h-[90vh] translate-y-0 opacity-100 transition-all duration-1000 ease-in-out">
      <div className="w-[90%] 800px:w-[80%]">
        <h1 className=" font-extrabold text-[25px] leading-[35px] sm:text-3xl lg:text-5xl tracking-tight text-center dark:text-white text-black font-Poppins 800px:!leading-[60px]">
        ...
        <div className="w-full text-center">
          <p className="800px:block hidden dark:text-white  font-poppins 800px:text-[22px] 800px:leading-[32px] text-[16px] leading-[23px] font-normal text-[#2d3134] mt-5 mb-10">
            Empower your programming journey with Becodemy <br /> dedicated
            community and comprehensive resources.
          </p>
          <p className="800px:hidden dark:text-white  block font-poppins 800px:text-[22px] 800px:leading-[32px] text-[16px] leading-[25px] font-normal text-[#2d3134] mt-5 mb-10">
